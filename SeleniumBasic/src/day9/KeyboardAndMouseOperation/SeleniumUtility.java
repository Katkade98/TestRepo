...
public  WebDriverWait wait ;
	public WebDriver SetUp(String browserName, String appUrl) {
		if (browserName.equalsIgnoreCase("chrome")) {
             //use setup method for  webDriverManager
			// WebDriverManager.chromedriver().setup();
            System.setProperty("webdriver.chrome.driver",".\\executables\\chromedriver.exe");
            //Step 2:create an instance of chrome driver
             driver=new ChromeDriver();
		}
		else if(browserName.equalsIgnoreCase("firefox"))
		{
			 System.setProperty("webdriver.gecko,drive",".\\executables\\geckodriver.exe");
			 //step2: create an instance of chrome driver
	...
	public void perfromClick(WebElement element)
	{
		element.click();
	}
	...
	public void copyPasteText(WebElement textToBeCopy,WebElement textToBePasted)
	{
		action.doubleClick(textToBeCopy).perform();
		textToBeCopy.sendKeys(Keys.chord(Keys.CONTROL,"c"));
